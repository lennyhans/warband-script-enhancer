...
#define CRC32_WARBAND_1173 0x9BC2046C
#define CRC32_WARBAND_STEAM_1173 0xCF9A0B96
#define CRC32_WARBAND_DEDICATED_1173 0x8AEDDD2A

#if defined DEBUG
#define THREAD_WAIT_TIMEOUT 1000000
#else
