...
unsigned int addresses::New = 0x0062B3D6;
//unsigned int addresses::Delete = 0x00682194;
unsigned int addresses::Delete = 0x0062ABF9;

//unsigned int addresses::window_manager_DisplayMessage = 0x00490700;
unsigned int addresses::window_manager_DisplayMessage = 0x004615F0;
...
unsigned int addresses::mesh_CreateVertexAnimMorph = 0x0050DD70;
unsigned int addresses::mesh_CreateCopy = 0x0041BFB0;
unsigned int addresses::mesh_CreateUniqueVertexData = 0x0041C230;

//unsigned int addresses::skeleton_GetBonePosition = 0x004E35B0;
unsigned int addresses::skeleton_GetBonePosition = 0x004A7D70;

//unsigned int addresses::scene_GetGroundData = 0x00437660;
unsigned int addresses::scene_GetGroundData = 0x00429A60;

//unsigned int addresses::CheckIntersection = 0x00417CF0;
unsigned int addresses::CheckIntersection = 0x00414280;

//unsigned int addresses::scene_GetBodyPartsInPath = 0x00448740;
unsigned int addresses::scene_GetBodyPartsInPath = 0x00435890;

//unsigned int addresses::capsule_Ctor = 0x00447E00;
unsigned int addresses::capsule_Ctor = 0x00434F40;
...
unsigned int addresses::New = 0x004FA7FD;
//unsigned int addresses::Delete = 0x004F1B0D;
unsigned int addresses::Delete = 0x004FA6FD;
...
unsigned int addresses::skeleton_GetBonePosition = 0x00458070;

//unsigned int addresses::scene_GetGroundData = 0x0040F6A0;
unsigned int addresses::scene_GetGroundData = 0x00410C70;

unsigned int addresses::CheckIntersection = 0x00406960;

//unsigned int addresses::scene_GetBodyPartsInPath = 0x0044F270;
unsigned int addresses::scene_GetBodyPartsInPath = 0x004506E0;

//unsigned int addresses::capsule_Ctor = 0x0044E720;
unsigned int addresses::capsule_Ctor = 0x0044FB80;
#endif
