...
unsigned int addresses::New = 0x0061EF86;
//unsigned int addresses::Delete = 0x00682194;
unsigned int addresses::Delete = 0x0061E7A9;

//unsigned int addresses::window_manager_DisplayMessage = 0x00490700;
unsigned int addresses::window_manager_DisplayMessage = 0x00462C70;
...
unsigned int addresses::mesh_CreateVertexAnimMorph = 0x0050F190;
unsigned int addresses::mesh_CreateCopy = 0x0041C0C0;
unsigned int addresses::mesh_CreateUniqueVertexData = 0x0041C340;

//unsigned int addresses::skeleton_GetBonePosition = 0x004E35B0;
unsigned int addresses::skeleton_GetBonePosition = 0x004A9500;

//unsigned int addresses::scene_GetGroundData = 0x00437660;
unsigned int addresses::scene_GetGroundData = 0x0042A0C0;
...
unsigned int addresses::scene_GetBodyPartsInPath = 0x00435FA0;

//unsigned int addresses::capsule_Ctor = 0x00447E00;
unsigned int addresses::capsule_Ctor = 0x00435650;
...
unsigned int addresses::New = 0x004FA68D;
//unsigned int addresses::Delete = 0x004F1B0D;
unsigned int addresses::Delete = 0x004FA58D;
...
unsigned int addresses::skeleton_GetBonePosition = 0x004582E0;

//unsigned int addresses::scene_GetGroundData = 0x0040F6A0;
unsigned int addresses::scene_GetGroundData = 0x00410DE0;

unsigned int addresses::CheckIntersection = 0x004068A0;

//unsigned int addresses::scene_GetBodyPartsInPath = 0x0044F270;
unsigned int addresses::scene_GetBodyPartsInPath = 0x00450920;

//unsigned int addresses::capsule_Ctor = 0x0044E720;
unsigned int addresses::capsule_Ctor = 0x0044FDC0;
#endif
