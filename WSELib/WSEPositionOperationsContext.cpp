...
void PositionRotateX(WSEPositionOperationsContext *context)
{
	...
	rgl::matrix *matrix = &data_basic_game->basic_game.position_registers[preg];
...
int PositionGetVectorToPosition(WSEPositionOperationsContext *context)
{
	...
	rgl::matrix *dest = &data_basic_game->basic_game.position_registers[preg1];
	rgl::vector4 pos1 = data_basic_game->basic_game.position_registers[preg2].o;
	rgl::vector4 pos2 = data_basic_game->basic_game.position_registers[preg3].o;
	...
	return (int)(v.length() * data_basic_game->basic_game.fixed_point_multiplier);
}
...
void PositionAlignToGround(WSEPositionOperationsContext *context)
{
	...
	rgl::matrix *dest = &data_basic_game->basic_game.position_registers[preg];
	float height;
	rgl::quad *quad;
