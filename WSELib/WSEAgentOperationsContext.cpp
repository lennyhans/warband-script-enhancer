...
void AgentAiGetMoveTargetPosition(WSEAgentOperationsContext *context)
{
	...
	data_basic_game->basic_game.position_registers[preg].rot.u = rgl::vector4(0.0f, 0.0f, 1.0f);
	data_basic_game->basic_game.position_registers[preg].orthonormalize();
	data_basic_game->basic_game.position_registers[preg].rotate_z(DEG2RAD(180));
}
