...
void WSESignatureScannerContext::FindRglAddresses()
{
	...
	rgl::addresses::window_manager_DisplayMessage = FindSignature("\x5F\x83\xC4\x40\xC3", "xxxxx") + 11;
	...
	rgl::addresses::scene_GetBodyPartsInPath = FindSignature("\xB8\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x8B\x94\x24", "x????x????xxx");
...
void WSESignatureScannerContext::FindWbAddresses()
{
	...
	wb::addresses::operation_Execute_entry = FindSignature("\x8B\x13\x52\x68", "xxxx");
	...
	wb::addresses::ReadModuleFiles_entry = FindSignature("\x81\xC4\x00\x00\x00\x00\xC3\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\x81\xEC\x00\x00\x00\x00\x53\x8B\x9C\x24", "xx????xxxxxxxxxxx????xxxx");
	...
	wb::addresses::network_client_ReceiveMessage_entry = FindSignature("\x0F\x87\x00\x00\x00\x00\xFF\x24\x85\x00\x00\x00\x00\x68\x00\x00\x00\x00\x68", "xx????xxx????x????x");
	...
	wb::addresses::XmlGetServerInfo = FindSignature("\x81\xEC\x00\x00\x00\x00\x53\x56\x68\x00\x00\x00\x00\x8D\x4C\x24\x14\xE8", "xx????xxx????xxxxx");

	wb::addresses::mission_CheckCollision_entry = FindSignature("\x80\x3A\x00\xB9", "xxxx");
	...
	wb::addresses::mission_CheckHit_Horse_entry = FindSignature("\x8B\xF1\x83\xE6\x0F\x69\xF6\x00\x00\x00\x00\x8B\xC1\xC1\xE8\x04\x8B\x04\x82\xD9\x84\x30", "xxxxxxx????xxxxxxxxxxx");
	...
	wb::addresses::mission_object_Hit_entry = FindSignature("\x81\xC1\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x83\x3D\x00\x00\x00\x00\x00\x7C\x25", "xx????x????xx?????xx");
	...
	wb::addresses::game_screen_EditProfileLoadSkinList_entry = FindSignature("\xB9\x00\x00\x00\x00\xE9\x00\x00\x00\x00\x8B\x8E\x00\x00\x00\x00\x8B\x11\x8B\x42\x58\x68\x00\x00\x00\x00\xFF\xD0\x84\xC0\x0F\x84\x00\x00\x00\x00\x81\xC6", "x????x????xx????xxxxxx????xxxxxx????xx");
	wb::addresses::game_screen_EditProfileLoadSkinList_exit = wb::addresses::game_screen_EditProfileLoadSkinList_entry + 5;

	wb::addresses::game_screen_EditProfileAllocateMemoryForSkins_entry = FindSignature("\x00\x00\x00\x00\x89\x44\x24\x1C\xC7\x00", "????xxxxxx");
	...
	wb::addresses::agent_EndReloading_entry_2 = FindSignature("\x5D\x5B\x81\xC4\x00\x00\x00\x00\xC2\x04\x00\x39\x35", "xxxx????xxxxx");
	...
	wb::addresses::item_kind_ShieldNoParryCouchedLance_exit_2 = wb::addresses::item_kind_ShieldNoParryMissiles_exit_2;
	...
	wb::addresses::network_server_ReceiveTeamChatEvent_entry = FindSignature("\x81\xC4\x00\x00\x00\x00\xC2\x04\x00\xCC\xCC\xCC\xCC\xCC\xCC\xCC\x81\xEC", "xx????xxxxxxxxxxxx") + 16;
	wb::addresses::network_server_ReceiveTeamChatEvent_exit = wb::addresses::network_server_ReceiveTeamChatEvent_entry + 6;

	wb::addresses::network_server_ReceiveChatEvent_entry = FindSignature("\x5D\x81\xC4\x00\x00\x00\x00\xC2\x08\x00\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\x81\xEC", "xxx????xxxxxxxxxxxxxxxxxxxx") + 25;
	wb::addresses::network_server_ReceiveChatEvent_exit = wb::addresses::network_server_ReceiveChatEvent_entry + 6;
	...
	wb::addresses::ParseConsoleCommand_entry = FindSignature("\x68\x00\x00\x00\x00\x8B\xCE\xE8\x00\x00\x00\x00\x84\xC0\x0F\x84\x00\x00\x00\x00\x83\x7C\x24\x10\x01\x0F\x85\x00\x00\x00\x00\x8D\x8C\x24", "x????xxx????xxxx????xxxxxxx????xxx");
	wb::addresses::ParseConsoleCommand_exit_1 = FindSignature("\x8D\x4C\x24\x18\xE8\x00\x00\x00\x00\x5F\x8B\xC6", "xxxxx????xxx");
	...
	wb::addresses::network_server_ReceiveMessageServerJoinRequest_entry = FindSignature("\xC7\x44\x24\x00\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x68\x00\x00\x00\x00\x68", "xxx?????x????x????x");
	...
	wb::addresses::agent_ReceiveShieldHit_entry = FindSignature("\x8B\xC8\x89\x4C\x24\x14\xDB\x44\x24\x14\xD8\x1D", "xxxxxxxxxxxx");
	wb::addresses::agent_ReceiveShieldHit_exit = wb::addresses::agent_ReceiveShieldHit_entry + 6;

	wb::addresses::mission_SpawnMissile_entry = FindSignature("\x80\x7C\x24\x13\x00\xD9\x9E", "xxxxxxx");
	wb::addresses::mission_SpawnMissile_exit = wb::addresses::mission_SpawnMissile_entry + 5;

	wb::addresses::missile_Dive_entry = FindSignature("\x89\x0D\x00\x00\x00\x00\x8B\x0D\x00\x00\x00\x00\x89\x1D", "xx????xx????xx");
	...
	wb::addresses::mission_object_Hit_entry = FindSignature("\x81\xC1\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x83\x3D", "xx????x????xx");
	wb::addresses::mission_object_Hit_exit = wb::addresses::mission_object_Hit_entry + 6;

	wb::addresses::agent_CancelSwing_entry = FindSignature("\x8B\x86\x00\x00\x00\x00\x33\xFF\x85\xC0\x7C\x1A", "xx????xxxxxx");
	wb::addresses::agent_CancelSwing_exit = FindSignature("\x85\xFF\x74\x4D\x8B\x07", "xxxxxx");

	wb::addresses::agent_DropItem_entry = FindSignature("\x81\xEC\x00\x00\x00\x00\x8B\x15", "xx????xx");
	wb::addresses::agent_DropItem_exit = wb::addresses::agent_DropItem_entry + 6;
	...
	wb::addresses::agent_EndReloading_entry_1 = FindSignature("\x5D\x5B\x81\xC4\x00\x00\x00\x00\xC2\x04\x00\x83\x3D", "xxxx????xxxxx");
